#!/usr/bin/env python3
"""Hybrid gshare + Bayesian neural network branch predictor."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run the gshare + BNN branch predictor.")
    parser.add_argument("--trace", required=True)
    parser.add_argument("--max-branches", type=int, default=None)
    parser.add_argument("--baseline-pc-bits", type=int, default=14)
